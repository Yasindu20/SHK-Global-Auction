...
export default function AdminDashboard() {
  ...
  const statCards = stats
    ? [
        ...
        },
        {
          ...
          delta: stats.total ? `${Math.round((stats.approved / stats.total) * 100)}%` : '0%',
          positive: true,
          Icon: CheckCircle,
          accent: '#22C55E',
        ...
        },
        {
          ...
          value: stats.pending,
          delta: stats.pending > 0 ? 'Needs attention' : 'All clear',
        ...
        },
        {
          ...
          delta: stats.total ? `${Math.round((stats.rejected / stats.total) * 100)}%` : '0%',
          positive: false,
          Icon: XCircle,
          accent: '#EF4444',
  ...
  const quickActions = [
    {
      label: 'Add Vehicle',
      desc: 'Manually create a listing',
    ...
    {
      label: 'Review Queue',
      desc: `${stats?.pending || 0} vehicles waiting`,
      href: '/admin/review',
      Icon: ClipboardList,
      accent: '#F59E0B',
    },
    {
      label: 'Crawl Monitor',
      desc: crawlStatus?.running ? 'Crawl in progress' : 'Start new crawl',
      href: '/admin/crawl',
      Icon: Radio,
      accent: '#22C55E',
    },
          ...
          <div className="space-y-2">
            {quickActions.map(({ label, desc, href, Icon, accent }) => (
              ...
              >
                ...
                <ArrowUpRight size={14} style={{ color: '#4B5563' }} className="group-hover:text-white transition-colors shrink-0" />
              </Link>
            ))}
          </div>
        </div>
